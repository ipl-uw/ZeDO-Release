...
from lib.dataset.custom import CustomDataset
...
def parse_args(argv):
    ...
    parser.add_argument('--eval', action='store_true', default=None, help='evaluation mode')
...
def main(args):
    ...
    np.save('results.npy', batch_results)
